setwd("~/Desktop/CS/Stuffs/DeepL/Learning-from-User-Representations/ddcrp")
library('Matrix')
library('tm')
...
##CIKM script
setwd("~/Desktop/CS/Stuffs/DeepL/Learning-from-User-Representations/ddcrp")
docs <- readLines("../data/Universal_Pool.csv")
...
stdist = read.csv("../data/Distance_Matrix.csv",head=F)
